...
# -------------------------------------------------
def fn_tile2latlon(xtile, ytile, zoom):
    n = 2.0**zoom
...
for item_poly in range(int_gdf_item + 1):
    ...
    gdf_clipped_tiles = gpd.overlay(gdf_current_poly_tiles, gdf_current_poly_request, how="intersection")
