...
## v1.27.1 - 2023-09-21 - [PR#165](https://github.com/NOAA-OWP/ras2fim/pull/165)

Errors were being thrown by conflate_hecras_to_nwm as it iterated through a shape layer, with some records being linestrings and others being multilinestrings.   Upon closer examination, it was doing some unnecessary "simplifing".  Cleaning that up took care of it, as it did not need to attempt to split a multi line string to independent segments to run simplify.
