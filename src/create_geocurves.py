...
def create_geocurves(ras2fim_huc_dir:str, code_version:str):
    ...
    # TODO: conflated_ras_models_csv = ras2fim_huc_dir + "\\02_csv_shapes_from_conflation" + "\\conflated_ras_models.csv"
    ...
    # TODO: nwm_streams_ln_shp = ras2fim_huc_dir + "\\02_csv_shapes_from_conflation" + "\\12090301_nwm_streams_ln.shp"
