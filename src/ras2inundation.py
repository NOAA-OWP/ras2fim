...
def inundate(rem, catchments, catchment_poly, hydro_table, forecast,
    ...
    try:
        os.environ["PROJ_LIB_BACKUP"] = os.environ["PROJ_LIB"]
...
def __inundate_in_huc(rem_array,catchments_array,crs,window_transform,rem_profile,catchments_profile,hucCode,
    ...
    if isinstance(inundation_raster,str):
        ...
        print(f"... Opening inundation raster {inundation_raster}")
    ...
    print(f"REM array and catchments array: {rem_array} and {catchments_array}")
    # create flat outputs
...
if __name__ == '__main__':
    ...
    # call function
    #inundate(**args)
    inundation_rasters,depth_rasters,inundation_polys = inundate(**args)
    print(depth_rasters)
