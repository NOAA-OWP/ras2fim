...
INPUT_LEVEE_PROT_AREA_FILE_PATH = os.path.join(
    INPUT_DEFAULT_X_NATIONAL_DS_DIR, "Leveed_Areas_NLDFS_5070_230314.gpkg"
)
...
INPUT_DEFAULT_WBD_NATIONAL_FILE_PATH = os.path.join(INPUT_DEFAULT_X_NATIONAL_DS_DIR, INPUT_WBD_NATIONAL_FILE)
INPUT_DEFAULT_NWM_FLOWS_FILE_PATH = os.path.join(INPUT_DEFAULT_X_NATIONAL_DS_DIR, INPUT_NWM_CATCHMENTS_FILE)
INPUT_3DEP_HUC8_10M_ROOT = os.path.join(ROOT_DIR_INPUTS, "dems", "ras_3dep_HUC8_10m")
INPUT_3DEP_DEFAULT_TERRAIN_DEM = os.path.join(INPUT_3DEP_HUC8_10M_ROOT, "HUC8_[]_w_levee_dem.tif")
