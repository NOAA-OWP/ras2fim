...
def fn_cut_dems_from_shapes(
    str_input_shp_path, str_cross_sections_path, str_input_terrain_path, str_output_dir, int_buffer, model_unit, 
    str_field_name
):
    ...
    # dissolve all huc12s together (cross sections -should- have same parent path in ras2fim v2, but this ensures dissolving)
...
if __name__ == "__main__":
    ...
    fn_cut_dems_from_shapes(
        str_input_shp_path, str_cross_sections_path, str_input_terrain_path, str_output_dir, int_buffer, model_unit, str_field_name
    )
